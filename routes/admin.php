...
Route::middleware(['auth:sanctum', 'admin.user'])->group(function (): void {
    ...
    Route::get('system/audit-logs/actions', [AdminLogController::class, 'auditActions'])->middleware('admin.permission:system.audit.view');
    ...
    Route::get('system/security/events', [AdminSecurityController::class, 'events'])->middleware('admin.permission:system.security.view');
    Route::post('system/security/events/{securityEvent}/resolve', [AdminSecurityController::class, 'resolve'])->middleware('admin.permission:system.security.update');
    Route::get('system/security/ip-blocks', [AdminSecurityController::class, 'blocks'])->middleware('admin.permission:system.security.view');
    ...
    Route::post('system/settings/logo', [AdminSettingController::class, 'uploadLogo'])->middleware(['admin.permission:system.setting.view', 'throttle:12,1']);
    Route::delete('system/settings/logo', [AdminSettingController::class, 'resetLogo'])->middleware('admin.permission:system.setting.view');
